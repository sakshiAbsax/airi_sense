          ...
          <div className="row justify-content-between align-items-center">
            <div className="col-md-8 col-lg-7 col-lg-6 mb-5">
              <div className="whatWeDo">
                <h1 style={{fontWeight:"600", color:"#128c7e" , letterSpacing:"3px"}} className="text-start">Pharma</h1>
                <p
      ...
      <section className="section_padding partnerSec1">
        <div className="container py-5">
          ...
          <div className="col-md-4 col-lg-4 mb-5">
            ...
            <div className="col-md-8 col-lg-7 col-lg-6 mb-5">
              <div className="whatWeDo">
                <h1 style={{fontWeight:"600", color:"#128c7e" , letterSpacing:"3px"}} className="text-start">Beverage</h1>
                <p
                  className="card-paragraph mt-4"
                  style={{ textAlign: "justify" }}
                >
      ...
      <section className="section_padding partnerSec1">
        <div className="container py-5">
          <div className="row justify-content-between align-items-center">
            <div className="col-md-8 col-lg-7 col-lg-6 mb-5">
              <div className="whatWeDo">
                <h1 style={{fontWeight:"600", color:"#128c7e" , letterSpacing:"3px"}} className="text-start">FMEG</h1>
                <p
                  className="card-paragraph mt-4"
                  style={{ textAlign: "justify" }}
                >
      ...
      <section className="section_padding partnerSec1">
        <div className="container py-5">
          ...
          <div className="col-md-4 col-lg-4 mb-5">
            ...
            <div className="col-md-8 col-lg-7 col-lg-6 mb-5">
              <div className="whatWeDo">
                <h1 style={{fontWeight:"600", color:"#128c7e" , letterSpacing:"3px"}} className="text-start">Food</h1>
                <p
                  className="card-paragraph mt-4"
                  style={{ textAlign: "justify" }}
                >
